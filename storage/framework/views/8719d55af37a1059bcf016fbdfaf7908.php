                            ...
                            <?php $__currentLoopData = $ruangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="<?php echo e(route('master.ruangan.destroy', $item->id)); ?>" method="POST" class="d-inline delete-form" data-item-name="<?php echo e($item->nama_ruangan); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\capstone-firdaus\resources\views/master/ruangan/index.blade.php ENDPATH**/ ?>