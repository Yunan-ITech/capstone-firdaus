...
if (recentAssetsData.length) {
    ...
    new Chart(recentAssetsCtx, {
        type: 'bar',
        data: {
            labels: recentAssetsData.map(item => item.nama),
            datasets: [{
                label: 'Barang Terbaru',
                data: recentAssetsData.map(() => 1),
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            const item = recentAssetsData[context.dataIndex];
                            return [
...
if (topRuanganData.length) {
    ...
    new Chart(topRuanganCtx, {
        type: 'bar',
        data: {
            labels: topRuanganData.map(item => item.nama),
            datasets: [{
                label: 'Jumlah Barang',
                data: topRuanganData.map(item => item.total),
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            const item = topRuanganData[context.dataIndex];
                            return 'Total: ' + item.total + ' barang';
                        }
                    }
                }
            },
