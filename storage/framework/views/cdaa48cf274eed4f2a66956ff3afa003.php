                            ...
                            <?php $__currentLoopData = $dataBarang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <?php if($firstUnit): ?>
                                            <form action="<?php echo e(route('assets.destroy', $firstUnit->id)); ?>" method="POST" class="d-inline" data-item-name="<?php echo e($barang['kode_inventaris_dasar']); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\capstone-firdaus\resources\views/assets/index.blade.php ENDPATH**/ ?>