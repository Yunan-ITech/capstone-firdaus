                                ...
                                <?php $__currentLoopData = $paginator; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo e(route('master.jenis-barang.destroy', $item->id)); ?>" method="POST" class="d-inline" data-item-name="<?php echo e($item->nama_barang); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\capstone-firdaus\resources\views/master/jenis-barang/index.blade.php ENDPATH**/ ?>