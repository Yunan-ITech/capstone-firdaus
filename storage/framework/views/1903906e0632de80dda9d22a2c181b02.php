        ...
        <div class="col-lg-10">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="text-muted">
                    <small><i class="fas fa-envelope me-1"></i><?php echo e(auth()->user()->email); ?></small>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('profile.update')); ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="name" type="text" class="form-control" value="<?php echo e(auth()->user()->name); ?>" disabled>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\capstone-firdaus\resources\views/profile/show.blade.php ENDPATH**/ ?>